...
// Dynamic import components that will be loaded client-side
function BookingAnalytics() {
  return (
    <div className="py-20 text-center">
      <GlassmorphismCard className="mx-auto max-w-md">
        <BarChart3 className="mx-auto mb-6 size-16 text-yellow-400" />
        <h3 className="mb-4 text-2xl font-bold text-white">Analytics View</h3>
...
function BookingCalendar() {
  return (
    <div className="py-20 text-center">
      <GlassmorphismCard className="mx-auto max-w-md">
        <CalendarIcon className="mx-auto mb-6 size-16 text-yellow-400" />
        <h3 className="mb-4 text-2xl font-bold text-white">Calendar View</h3>
        <p className="text-white/70">Calendar view will be implemented here</p>
      </GlassmorphismCard>
    </div>
  )
}
